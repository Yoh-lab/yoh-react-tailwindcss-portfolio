...
const About = (props) => {
  ...
  return (
    <>
      <div onClick={setShowModal} className="z-30">
        <button>
          <AboutCard
            title={props.title}
...
//       <div className="container my-6 p-4 bg-white rounded-lg relative">
//       <>
//           <div className="w-screen   justify-center items-center flex fixed inset-0 z-50 outline-none focus:outline-none">
//             <div className="container my-6 p-4  relative">
//               {/*content*/}
//               <div className="rounded-lg flex-col bg-white outline-none focus:outline-none">
//                 {/*header*/}
//                 <div className="border-b border-solid border-slate-200">
//                   <div className="flex items-center justify-between px-6 pt-4">
//                     <div className="flex items-center">
...
//         </>
//       </div>
//       <div className="fixed inset-0 opacity-25 bg-black z-40"></div>
//     </div>
//   );
// };
